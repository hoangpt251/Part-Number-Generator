...
PACKING_FILE = os.path.join(BASE_DIR, "core", "data", "packing.xlsx")

# Đọc các sheet một lần khi import module
_sheets = {}
if os.path.exists(PACKING_FILE):
    with pd.ExcelFile(PACKING_FILE) as xls:
        try:
            ...
            print(f"Lỗi đọc file packing.xlsx: {e}")
            _sheets = {}
else:
    print("Không tìm thấy file packing.xlsx, chỉ sử dụng entry fields")
    _sheets = {}
